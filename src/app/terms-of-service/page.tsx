      ...
      <div className="max-w-4xl mx-auto px-4 py-12 bg-black ">
        ...
        <Section title="11. Governing Law">
          <p>
            ...
            laws of [Insert Country/State]. Disputes will be resolved in the
            courts of Nigeria.
          </p>
        </Section>
        ...
        <Section title="12. Changes to the Terms">
          <p>
            ...
            changes, we’ll notify you through the Service or by other means.
            Continued use means acceptance of the new Terms.
          </p>
        </Section>
